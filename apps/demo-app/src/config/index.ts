...
export const CONFIG: OAuthConfig = {
  ...
  authorizeUrl: getEnvVar('VITE_OAUTH_AUTHORIZE_URL', 'https://zeta.cyole.dev/oauth2/authorize'),
  tokenUrl: getEnvVar('VITE_OAUTH_TOKEN_URL', 'https://zeta.cyole.dev/api/oauth2/token'),
  userInfoUrl: getEnvVar('VITE_OAUTH_USER_INFO_URL', 'https://zeta.cyole.dev/api/oauth2/me'),
}
