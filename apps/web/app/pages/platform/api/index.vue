...
<template>
  <div class="p-6">
    ...
    <div class="grid md:grid-cols-4 gap-4 mb-8">
      <div class="p-4 bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800 cursor-pointer hover:border-orange-300 dark:hover:border-orange-700 transition-all group">
    ...
    <div class="bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800">
      ...
      <div class="p-8 text-center text-neutral-400 dark:text-neutral-500">
