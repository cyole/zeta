<template>
  <div>
    <!-- Page header -->
    <div class="mb-8">
      <h1 class="text-2xl font-bold text-neutral-900 dark:text-white">个人设置</h1>
    ...
    <div class="grid gap-6 lg:grid-cols-3">
        ...
        <UForm :state="form" :schema="schema" @submit="onSubmit" class="space-y-6">
          ...
          <div class="flex items-center gap-4">
            ...
            <div>
              ...
              <p class="mt-1 text-xs text-neutral-500">暂不支持上传</p>
            </div>
          </div>
      ...
      <div class="space-y-6">
        ...
        <UCard>
          <template #header>
            <h3 class="font-semibold">关联账号</h3>
          </template>
          <div class="space-y-3">
            <div class="flex items-center justify-between">
              ...
              <UBadge v-if="hasGitHub" color="success" variant="subtle">已关联</UBadge>
              <UButton v-else size="xs" variant="outline" @click="linkGitHub">关联</UButton>
            </div>
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-2">
              ...
              <UBadge v-if="hasDingTalk" color="success" variant="subtle">已关联</UBadge>
              <UButton v-else size="xs" variant="outline" @click="linkDingTalk">关联</UButton>
            </div>
          </div>
        </UCard>
        ...
        <UCard>
          <template #header>
            <h3 class="font-semibold">账号信息</h3>
          </template>
          <dl class="space-y-2 text-sm">
            <div class="flex justify-between">
              <dt class="text-neutral-500">账号状态</dt>
              <dd>
            ...
            <div class="flex justify-between">
              <dt class="text-neutral-500">注册时间</dt>
              <dd>{{ formatDate(user?.createdAt) }}</dd>
            </div>
            <div class="flex justify-between">
              <dt class="text-neutral-500">最后登录</dt>
