...
// Stats
const stats = [
  { label: '代码生成', value: '156', colorClass: 'text-primary-500', trend: 12 },
  { label: '文档查询', value: '89', colorClass: 'text-green-500', trend: 8 },
  { label: '接口生成', value: '34', colorClass: 'text-orange-500', trend: 5 },
  { label: '测试用例', value: '67', colorClass: 'text-secondary-500', trend: 0 },
]

// Recent activities
const recentActivities = [
  { id: 1, icon: 'i-lucide-code-2', title: '使用编码助手生成了用户列表组件', time: '10 分钟前', bgClass: 'bg-secondary-500' },
  { id: 2, icon: 'i-lucide-book-open', title: '查询了 Table 组件的分页配置文档', time: '25 分钟前', bgClass: 'bg-green-500' },
  { id: 3, icon: 'i-lucide-figma', title: '从 Figma 设计稿生成了登录页面代码', time: '1 小时前', bgClass: 'bg-primary-500' },
...
// Features
const features = [
  { title: '智能代码生成', description: '基于 AI 的代码生成能力，支持自然语言描述转代码', icon: 'i-lucide-wand-2', bgClass: 'bg-primary-500' },
  { title: '团队知识库', description: '统一管理组件文档、接口文档，AI 智能检索', icon: 'i-lucide-library', bgClass: 'bg-emerald-500' },
  { title: '设计稿识别', description: '自动识别 Figma 设计稿，精准生成组件代码', icon: 'i-lucide-scan', bgClass: 'bg-secondary-500' },
  ...
  <div class="min-h-full">
    ...
    <div class="max-w-7xl mx-auto px-6 py-8">
      ...
      <section class="mb-10">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          <NuxtLink
            ...
            :key="module.to"
            :to="module.to"
            class="group flex flex-col items-center p-5 bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800 hover:border-primary-300 dark:hover:border-primary-700 hover:shadow-lg hover:shadow-primary-500/10 transition-all"
          >
            <div
              class="w-12 h-12 rounded-xl flex items-center justify-center mb-3 transition-transform group-hover:scale-110" :class="[
                module.bgClass,
              ]"
            >
              <UIcon :name="module.icon" class="w-6 h-6 text-white" />
            </div>
            <span class="text-sm font-medium text-neutral-700 dark:text-neutral-300">{{ module.label }}</span>
            <span class="text-xs text-neutral-400 dark:text-neutral-500 mt-1">{{ module.desc }}</span>
          </NuxtLink>
        </div>
      </section>
      ...
      <div class="grid lg:grid-cols-3 gap-6 mb-10">
        <!-- Usage Stats -->
        <div class="lg:col-span-2 bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800 p-6">
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div v-for="stat in stats" :key="stat.label" class="text-center">
              <div class="text-3xl font-bold" :class="[stat.colorClass]">
                {{ stat.value }}
              </div>
              <div class="text-sm text-neutral-500 dark:text-neutral-400 mt-1">
                {{ stat.label }}
              </div>
              <div class="text-xs mt-1" :class="[stat.trend > 0 ? 'text-green-500' : 'text-neutral-400']">
          ...
          <div class="space-y-4">
            <div>
              <div class="flex items-center justify-between text-sm mb-2">
                <span class="text-neutral-600 dark:text-neutral-400">本月已用</span>
                <span class="font-medium text-neutral-900 dark:text-white">1,234 / 5,000</span>
              </div>
              <div class="h-2 bg-neutral-100 dark:bg-neutral-800 rounded-full overflow-hidden">
                <div class="h-full bg-gradient-to-r from-primary-500 to-secondary-500 rounded-full" style="width: 24.68%" />
              </div>
            </div>
            <div class="pt-4 border-t border-neutral-100 dark:border-neutral-800">
              <div class="flex items-center justify-between">
                <span class="text-sm text-neutral-600 dark:text-neutral-400">剩余额度</span>
                <span class="text-lg font-bold text-primary-600 dark:text-primary-400">3,766</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="grid lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800 p-6">
          ...
          <div class="space-y-4">
            ...
            >
              <div class="w-8 h-8 rounded-lg flex items-center justify-center shrink-0" :class="[activity.bgClass]">
      ...
      <section class="mt-10">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div
            ...
            :key="feature.title"
            class="p-5 bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800"
          >
            <div class="flex items-start gap-4">
              <div class="w-10 h-10 rounded-lg flex items-center justify-center shrink-0" :class="[feature.bgClass]">
