...
<template>
  <div class="min-h-screen bg-white dark:bg-neutral-950">
    ...
    <section class="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16">
        <div class="text-center max-w-4xl mx-auto">
          <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-50 dark:bg-primary-950/50 border border-primary-200 dark:border-primary-800 mb-8">
            ...
            <span class="text-sm text-primary-700 dark:text-primary-300">AI 驱动的前端提效平台</span>
          </div>
      ...
      <!-- Scroll indicator -->
      <div class="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-neutral-400">
        <span class="text-xs">向下滚动</span>
        <div class="w-6 h-10 border-2 border-neutral-300 dark:border-neutral-700 rounded-full flex justify-center pt-2">
          <div class="w-1.5 h-1.5 bg-neutral-400 dark:bg-neutral-600 rounded-full animate-bounce" />
        </div>
      </div>
    </section>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div class="flex items-center gap-6 text-sm text-neutral-600 dark:text-neutral-400">
            <a href="#" class="hover:text-primary-600 dark:hover:text-primary-400 transition-colors">使用文档</a>
            <a href="#" class="hover:text-primary-600 dark:hover:text-primary-400 transition-colors">问题反馈</a>
          </div>
